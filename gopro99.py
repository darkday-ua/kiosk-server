	...
	if "HD4" in response or "HD3.2" in response or "HD5" in response or "HX" in response or "HD6" or "HD7" in response:
		...
		if "HX" in response:
			...
			while connectedStatus == False:
				...
				print("-")
		subprocess.Popen("ffmpeg -i udp://10.10.10.100:10099 -fflags nobuffer -probesize 512  -c:v copy -b:v 5M -pix_fmt yuv420p -g 0 -an -f hls -hls_time 2 -hls_list_size 2 -hls_allow_cache 0 -hls_flags delete_segments /project/kiosk-app/streaming/gopro99_.m3u8", shell=True)
